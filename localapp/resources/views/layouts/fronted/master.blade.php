  ...
  <footer id="footer" class="footer bg-black-222" >
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-black-777 m-0">Copyright &copy; PSB University 2007 - <?php echo date('Y'); ?><a target="_blank" href="http://www.iwebcambodia.com"> PING IT GROUP</a></p>
          </div>
