    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{ url('/adminsite') }}">
                <img src="{{ asset('themes/login/img/PSBU-02_small.png') }}" alt="logo" class="logo-default" style="margin-top: -0.5px;" height="80" /> </a>
            ...
            <ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						...
						@if(App::getLocale() == 'en')
							<span class="badge badge-default"> E </span>
						@else
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="{{ asset('themes/backend/metronic3/assets/pages/img/pitlogo.png') }}" />
