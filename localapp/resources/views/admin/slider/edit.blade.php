              ...
              <br>
                  {!! Form::open(['route' => ['sliders.update', $slider->id], 'method' => 'PUT']) !!}
                    ...
                    <div class="input-group">
                       ...
                       <input id="thumbnail" class="form-control" type="text" value="{{$slider->image}}" name="filepath">
                     </div>
                     <img id="holder" src="{{url('')}}/{{$slider->image}}" style="margin-top:15px;max-height:100px;">
                    <div class="form-group">
                        {{ Form::label('body', trans('lang.description')) }}
                        {{ Form::textarea('body', $slider->des, ['class' => 'form-control','id' => 'my-editor']) }}
                    </div>
                    <div class="form-group">
