              ...
              <table class="datatable table table-striped table-bordered no-footer" role="grid" aria-describedby="datatable_info">
                <thead>
                  <tr>
                      ...
                      <th  style="text-align: center;">{{trans('lang.code')}}</th>
                      <th  style="text-align: center;">{{trans('lang.parent')}}</th>
...
$(document).ready(function() {
  $('.datatable').DataTable({
       processing: true,
       serverSide: true,
       ajax: '{{ url("getCategoryBrand") }}',
       columns: [
            {data: 'id', name: 'id'},
            {data: 'b_name_en', name: 'b_name_en'},
            {data: 'b_name_kh', name: 'b_name_kh'},
            {data: 'code', name: 'code'},
