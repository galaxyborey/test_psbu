    ...
    <div class="row">
        <div class="col-md-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br>
                  {!! Form::open(['route' => ['matchgallerys.update', $edit->id], 'method' => 'PUT']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{route('matchgallerys.index')}}" class="btn btn-sm btn-danger"> <i class="fa fa-trash"></i> {{trans('lang.cancel')}}</a>
                    </div>
