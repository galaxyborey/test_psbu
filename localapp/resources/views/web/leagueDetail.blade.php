		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 class="page-title" style="text-transform: capitalize;">{{trans('lang.view_detail')}}</h1>
					<ul>
						<li>
...
<div class="champion-section-area sec-spacer">
	<div class="container">
		@foreach(\App\Http\Controllers\Web\PageController::getPositionData('positon_top_center',$cat->id,0) as $key=>$value)
						...
						<table class="match-table">
							<tbody>
								<tr>
									...
									@foreach(\App\Http\Controllers\Web\PageController::getDetailLeagueData($leagues->id) as $key=>$value)
									<tr>
	                        ...
	                        <table class="match-table">
	                            <tbody>
	                              @if(\App\Http\Controllers\Web\PageController::getLeagueDataActive())
	                                @foreach(\App\Http\Controllers\Web\PageController::getMatchResultData($leagues->id) as $key=>$value)
	                                <tr>
	                                  <td>
		...
		@foreach(\App\Http\Controllers\Web\PageController::getPositionData('position_buttom_center',$cat->id,0) as $key=>$value)
