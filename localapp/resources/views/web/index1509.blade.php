      ...
      <div class="row">
          <div class="container row">
              <div class="HomeShow show ClassHomeTab">
                @foreach(\App\Http\Controllers\Web\PageController::getCatNews('packages','') as $row)
              ...
              <div class="Classic hide ClassHomeTab">
                @foreach(\App\Http\Controllers\Web\PageController::getCatNews('packages','Classic') as $row)
              ...
              <div class="Deluxe hide ClassHomeTab">
                @foreach(\App\Http\Controllers\Web\PageController::getCatNews('packages','Deluxe') as $row)
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item">
                    <div class="hotel-box">
                        <!--header -->
                        <div class="header clearfix">
              ...
              <div class="Royal hide ClassHomeTab">
                @foreach(\App\Http\Controllers\Web\PageController::getCatNews('packages','Royal') as $row)
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item">
                    <div class="hotel-box">
                        <!--header -->
                        <div class="header clearfix">
              ...
              <div class="Luxury hide ClassHomeTab">
                @foreach(\App\Http\Controllers\Web\PageController::getCatNews('packages','Luxury') as $row)
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item">
                    <div class="hotel-box">
                        <!--header -->
                        <div class="header clearfix">
...
<div class="events-secion">
    <div class="container">
        ...
        <div class="main-title">
            ...
            <p>Check out our hotel evenrs</p>
        </div>
        <div class="row">
          @foreach(\App\Http\Controllers\Web\PageController::getCatNews('event','') as $row)
