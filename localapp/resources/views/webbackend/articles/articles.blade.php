	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/articleinsertSave')}}" id="form_validation">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('ifs_ne') ? ' has-error' : '' }}">
									...
									?>
									<div class="col-md-8">
										{{ Form::select('ifs_ne', $ifs_ne, old('ifs_ne'), ['id' => 'ifs_ne','class'=>'form-control']) }}
								...
								<div class="form-group{{ $errors->has('ne_date') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="ne_date" type="text" class="date datepicker form-control" name="ne_date" value="<?php echo date("00-00-0000");?>">
									</div>
								</div>
								<div class="form-group{{ $errors->has('e_location') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="e_location" type="text" class="form-control" name="e_location" value="{{ old('e_location') }}">
								...
								<div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="slug" type="hidden" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="Entry auto">
										@if ($errors->has('slug'))
											<span class="help-block">
