...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="#">{{ trans('template.article') }}</a>
		</li>
	</ul>
</div>
<br/>
	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="{{url('/adminsite/articles/create')}}" title="{{ trans('template.add_new') }}">
								...
								<td>
									<div class="btn-group">
					                    ...
					                    <ul class="dropdown-menu pull-right" role="menu">
					                        <li>
					                            <a class="font-blue bold" href="{{ url('adminsite/articles/edit/').'/'.$news->id }}?articlesdetails">
