	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="{{url('/adminsite/system/partners/create')}}" title="{{ trans('template.add_new') }}">
						...
						<table class="table table-striped table-bordered" width="100%" id="table-product">
							<thead>
								<tr class="bg-primary">
									...
									<th class="text-center min-phone-l">{{trans('template.our_partners')}}</th>
							...
							<tr>
								...
								<div class="btn-group">
					                    ...
					                    <ul class="dropdown-menu pull-right" role="menu">
					                        <li>
					                            <a class="font-blue bold" href="{{ url('adminsite/system/partners/editpartners/').'/'.$slide->id }}?partnersdetail">
					                                <i class="font-blue fa fa-edit"></i>{{trans('template.edit')}} </a>
												
					                        </li>
											<li>
					                             <a class="font-red bold" href="{{ url('adminsite/system/partners/delete/').'/'.$slide->id }}?partnersdelete">
								...
								<td><?php
									if(!empty($slide->image)) {?>
										<img src="{{URL('/')}}{{$slide->image}}" alt="{{ $slide->title }}" width="120">
									<?php
									}
									?>
								</td>
