	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/partnersUpdateSave')}}" id="form_validation">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										...
										<input id="id" type="hidden" class="form-control" name="id" value="{{ $partners[0]->id }}" >
										<input id="title" type="text" class="form-control" name="title" value="{{ $partners[0]->title }}" autofocus>
										@if ($errors->has('title'))
								...
								<div class="form-group{{ $errors->has('webs') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="webs" type="text" class="form-control" name="webs" value="{{ $partners[0]->links }}" placeholder="www.example.com">
										@if ($errors->has('webs'))
											<span class="help-block">
								...
								<div class="form-group">
									<div class="col-md-offset-4 col-md-8">
										<?php
											...
											<img src="{{URL('/')}}{{$partners[0]->image}}" alt="{{ $partners[0]->title }}" width="120">
											<?php
											}else{
												echo "No Photo";
											}
							...
							<div class="col-md-6">
								<div class="form-group{{ $errors->has('ordering') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="ordering" type="ordering" class="form-control" name="ordering" value="{{ $partners[0]->ordering }}">
								...
								<div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="slug" type="hidden" class="form-control" name="slug" value="{{ $partners[0]->slug }}">
										@if ($errors->has('slug'))
											<span class="help-block">
									...
									<div class="" role="tabpanel" data-example-id="togglable-tabs">
										...
										<div id="myTabContent" class="tab-content">
											...
											<div class="form-group">
													...
													{{ Form::textarea('body', ($partners[0]->des), ['class' => 'form-control','id' => 'my-editor_en']) }}
											</div>
											</div>
