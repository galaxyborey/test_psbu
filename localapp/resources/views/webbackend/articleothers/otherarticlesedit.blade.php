	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/articleUpdateSave')}}" id="form_validation">
						...
						<div class="row">
							...
							<div class="col-md-6">			
								...
								<div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="slug" type="text" class="form-control" name="slug" value="{{ $findnews->slug }}" placeholder="Entry auto">
										@if ($errors->has('slug'))
											<span class="help-block">
