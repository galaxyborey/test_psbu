	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/sliderInsertSave')}}" id="form_validation">
						...
						<div class="row">
							...
							<div class="col-md-6">			
								<div class="form-group{{ $errors->has('ordering') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="ordering" type="text" class="form-control" name="ordering" value="{{ old('ordering') }}" autocomplete="off">
