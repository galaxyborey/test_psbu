...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="#">{{ trans('template.category') }} 3</a>
		</li>
	</ul>
</div>
<br/>
	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="{{url('/adminsite/catemenu/subicatemenu/create')}}" title="{{ trans('template.add_new') }}">
				...
				<div class="col-md-12">
					@if(Session::has('message'))
						...
						<table class="table table-striped table-bordered" width="100%" id="table-product">
							...
							<tbody>
							@foreach($subi_categories as $key=>$subi)
							<tr>
							
								<td>{{ ($key+1) }}</td>
								<td>{{ $subi->subi_name }}</td>
								<td>{{ $subi->subi_namekh }}</td>
								<td>
								@if($subi->subi_active == 1)
								...
								<div class="btn-group">
					                    ...
					                    <ul class="dropdown-menu pull-right" role="menu">
					                        <li>
					                            <a class="font-blue bold" href="{{ url('adminsite/catemenu/subicate/edit/').'/'.$subi->id }}?subicatedetails">
