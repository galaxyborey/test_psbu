	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="{{url('/adminsite/catemenu/create')}}" title="{{ trans('template.add_new') }}">
					...
					@if(Session::has('message'))
						...
						<table class="table table-striped table-bordered" width="100%" id="table-product">
							...
							<tr>
								...
								<td>
								<?php
									foreach ($subcate as $skey => $suval){
										if($category->id == $suval->category_id){
											echo @$suval->name.", ";
										}
								...
								<div class="btn-group">
					                    ...
					                    <ul class="dropdown-menu pull-right" role="menu">
					                        <li>
					                            <a class="font-blue bold" href="{{ url('adminsite/catemenu/edit/').'/'.$category->id }}?catedetails">
