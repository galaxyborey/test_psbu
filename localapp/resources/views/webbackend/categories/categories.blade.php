	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/cateinsertSave')}}" id="form_validation">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
									<label for="name" class="col-md-4 control-label"><strong>{{ trans('lang.category_name_kh') }}</strong>
										<span class="">  </span>
									</label>
									<div class="col-md-8">
