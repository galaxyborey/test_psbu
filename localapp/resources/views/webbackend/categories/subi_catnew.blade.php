...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{url('/adminsite/catemenu/create')}}">{{ trans('template.category') }} 3</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/subiCateInsertSave')}}" id="form_validation">
					...
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-6">			
								<div class="form-group{{ $errors->has('catesubmaster') ? ' has-error' : '' }}">
									<label for="catesubmaster" class="col-md-4 control-label"><strong>{{ trans('template.category') }}</strong>
										<span class="">  </span>
									</label>
									<div class="col-md-8">
										
										<select name="catesubmaster" id="catesubmaster" class="form-control">

		                                <?php $lencm_i =0; $arrcm_i = (array)$cate2menu; $lencm_i = count($arrcm_i);
		                                if($lencm_i > 0){?>
		                                		<option value=""> {{ trans('template.select') }} </option><?php
			                                foreach($cate2menu as $val){?>
										...
										@if ($errors->has('catesubmaster'))
											<span class="help-block">
												<strong>{{ $errors->first('catesubmaster') }}</strong>
											</span>
										@endif
									</div>
								</div>
