	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-form bordered">
			...
			<div class="portlet-body form-body">
				<form class="form-horizontal" method="POST" action="{{url('/adminsite/subCateUpdateSave')}}" id="form_validation">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group{{ $errors->has('name_kh') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										...
										<input id="subid" type="hidden" class="form-control" name="subid" value="{{ $subcate->id }}" >
										<input id="name_kh" type="text" class="form-control" name="name_kh" value="{{ $subcate->name_kh }}" autofocus>
								...
								<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="name" type="text" class="form-control" name="name" value="{{ $subcate->name }}">
										@if ($errors->has('name'))
											<span class="help-block">
												<strong>{{ $errors->first('name') }}</strong>
											</span>
								...
								<div class="form-group{{ $errors->has('ordering') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<input id="ordering" type="ordering" class="form-control" name="ordering" value="{{ $subcate->sub_ordering }}" require>
								...
								<div class="form-group">
									<label for="sldier" class="col-md-4 control-label"><strong>{{ trans('template.photo') }}</strong>
										<span class="">  </span>
									</label>
									<div class="col-md-8">
								...
								<div class="form-group">
									<div class="col-md-offset-4 col-md-8">
										<?php
											if(!empty($subcate->is_picture)){?>
											<img src="{{URL('/')}}{{$subcate->is_picture}}" alt="{{ $subcate->name }}" width="200">
											<?php
											}else{
												echo "No Photo";
											}
							...
							<div class="col-md-6">			
								...
								<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<select name="pagecate" class="form-control">
											<option value="0"> {{ trans('template.select') }} </option><?php $catepid = $subcate->scatepageid;?>
										<?php 
								...
								<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
									...
									<div class="col-md-8">
										<select name="status" id="status" class="form-control">
		                                    <?php $status = $subcate->subcat_active;?>
								...
								<div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
									...
									<div class="col-md-5">
										<input id="slug" type="text" class="form-control" name="slug" value="{{ $subcate->slug }}">
										@if ($errors->has('slug'))
											<span class="help-block">
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab"><!--
               ...
               <div class="form-group">
                    ...
                    {{ Form::textarea('body', $subcate->body, ['class' => 'form-control','id' => 'my-editor_en']) }}
               </div>
            </div>
            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab"><!--
              ...
              <div class="form-group">
                  {{ Form::label('body', trans('lang.description')) }}
                  {{ Form::textarea('body_kh', $subcate->subbodykh, ['class' => 'form-control','id' => 'my-editor']) }}
              </div>
            </div>
          </div>
        </div>
